<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 64px","margin":"0","position":"relative","background":"#f3f3f3","display":"block"} : {"minHeight":"100%","padding":"0 0 0 210px","margin":"0","position":"relative","background":"#f3f3f3","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0px 120px 0px 20px","margin":"0 auto","borderColor":"rgba(126, 96, 16, .2)","alignItems":"center","color":"#999","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"linear-gradient(180deg, rgba(255,255,255,1) 35%, rgba(230,230,230,1) 100%),#fff","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"14px","position":"fixed","borderStyle":"solid","zIndex":"1","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"16px 30px","margin":"60px auto 0","borderColor":"#eee","borderWidth":"0 0 0px 0","width":"auto","fontSize":"14px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
