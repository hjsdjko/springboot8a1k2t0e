	...
	mounted() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'liushouertong') {
					this.avatar = data.data.touxiang
				}
				if(sessionTable == 'xinliyisheng') {
					this.avatar = data.data.touxiang
				}
