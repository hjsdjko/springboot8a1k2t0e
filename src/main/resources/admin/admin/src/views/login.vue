  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230928/03f8bd1ca8ab45c6ada205c6e80a1304.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-start"}'>
      <el-form :style='{"border":"1px solid #f6f6f6","padding":"20px 20px","margin":"50px 0 50px 60px","borderRadius":"8px","textAlign":"center","background":"rgba(255,255,255,1)","width":"50vw","fontSize":"14px","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"0px auto 10px","borderColor":"#ddd","color":"#333","textAlign":"center","display":"inline-block","background":"none","borderWidth":"0px","width":"100%","lineHeight":"40px","fontSize":"24px","borderStyle":"solid","fontWeight":"600"}' class="title-container">基于web的留守儿童网站的设计与实现登录</div>
        ...
        <div :style='{"margin":"40px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"60%","fontSize":"16px","position":"relative","justifyContent":"center"}'>
          ...
          <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0 8px","margin":"0 0px 10px","borderColor":"rgba(167,142,68,1)","color":"#333","outline":"none","borderRadius":"0px","background":"#d3d3d3","borderWidth":"0px","width":"100%","fontSize":"inherit","borderStyle":"solid","fontWeight":"600","height":"50px"}' type="primary" @click="register('xinliyisheng')" class="register">注册心理医生</el-button>
        </div>
      </el-form>
