	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="家庭情况" prop="jiatingqingkuang">
					<el-input v-model="ruleForm.jiatingqingkuang" placeholder="家庭情况" clearable  :readonly="ro.jiatingqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="家庭情况" prop="jiatingqingkuang">
					<el-input v-model="ruleForm.jiatingqingkuang" placeholder="家庭情况" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				ertongzhanghao: [
					{ required: true, message: '儿童账号不能为空', trigger: 'blur' },
				],
				mima: [
