<template>
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="资源名称" prop="ziyuanmingcheng">
					<el-input v-model="ruleForm.ziyuanmingcheng" placeholder="资源名称" clearable  :readonly="ro.ziyuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="资源名称" prop="ziyuanmingcheng">
					<el-input v-model="ruleForm.ziyuanmingcheng" placeholder="资源名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="资源类型" prop="ziyuanleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="资源类型" prop="ziyuanleixing">
					<el-input v-model="ruleForm.ziyuanleixing"
						placeholder="资源类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info'&& !ro.ziyuanwenjian" label="资源文件" prop="ziyuanwenjian">
					<file-upload
						tip="点击上传资源文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.ziyuanwenjian" label="资源文件" prop="ziyuanwenjian">
					<el-button :style='{"border":"2px solid #000","cursor":"pointer","padding":"0 20px","margin":"0 20px 0 0","color":"inherit","textAlign":"left","minWidth":"350px","outline":"none","borderRadius":"0px","background":"none","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.ziyuanwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="!ruleForm.ziyuanwenjian" label="资源文件" prop="ziyuanwenjian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.ziyuantupian" label="资源图片" prop="ziyuantupian">
					<file-upload
						tip="点击上传资源图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.ziyuantupian" label="资源图片" prop="ziyuantupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="资源简介" prop="ziyuanjianjie">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.ziyuanjianjie" label="资源简介" prop="ziyuanjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","background":"none","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ziyuanjianjie}}</span>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiaoyuziyuan/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiaoyuziyuanCrossAddOrUpdateFlag = false;
											this.parent.search();
