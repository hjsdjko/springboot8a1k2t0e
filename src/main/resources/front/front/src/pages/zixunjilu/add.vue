...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="咨询时间" prop="zixunshijian">
              <el-date-picker
				  :disabled="true  ||ro.zixunshijian"
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="咨询内容" prop="zixunneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="咨询内容"
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('zixunjilu/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`zixunjilu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
